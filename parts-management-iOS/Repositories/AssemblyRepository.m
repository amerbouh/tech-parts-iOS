...
{
    FIRCollectionReference * assembliesCollection = [_database collectionWithPath:ASSEMBLIES_COLLECTION_NAME];
...
{
    FIRQuery * query = [[_database collectionWithPath:ASSEMBLIES_COLLECTION_NAME] queryWhereField:@"projectId" isEqualTo:projectIdentifier];
