...
/**
 ...
 @param userId              An NSString reprsesenting the unique identifier of the user.
 ...
 */
- (void)completeSignUpProcessForUserWithId:(NSString * _Nonnull)userId emailAddress:(NSString * _Nonnull)emailAddress firstName:(NSString * _Nonnull)firstName lastName:(NSString * _Nonnull)lastName completionHandler:(void (^_Nullable)(NSError * _Nullable error))completionHandler;
